...
@$id_membership_profile = $_GET['id_membership_profile']; 
    ...
    ;
        // $url = Yii::getAlias('@web')."/membership-document/upload?folder=14";
        
        
        echo    \kato\DropZone::widget([
            'options' => [
                'url'=>Yii::getAlias('@web')."/membership-document/upload?folder=".$folder."&id_membership_profile=".$id_membership_profile, 
                'maxFilesize' => '5',
                'maxFiles'=>10,
                'addRemoveLinks'=>true,
                'multipleUpload'=>true,
...
$url = Yii::getAlias('@web')."/membership-document/remove-file";
