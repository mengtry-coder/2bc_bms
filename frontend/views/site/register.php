...
<div class="site-signup"> 
    <div class="panel">
        <div class="eq-height clearfix">
            <div class="col-md-4 col-xs-12 eq-box-md eq-box-xs text-center box-vmiddle-wrap bord-hor">
            ...
            <div class="col-md-8 col-xs-12 eq-box-md eq-box-xs eq-no-panel">
                ...
                <div id="demo-main-wz">
                    ...
                    <div class="progress progress-xs">
                        <div class="progress-bar progress-bar-primary" style="width: 25%; left: 0%; position: relative; transition: all 0.5s ease 0s;"></div>
                    </div>
                    ...
                    <form class="form-horizontal">
                        ...
                        <div class="pull-right pad-rgt mar-btm">
                            ...
                            <button type="button" class="finish btn btn-success" style="display: none;" disabled="">Finish</button>
                        </div>
