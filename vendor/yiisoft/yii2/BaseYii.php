...
class BaseYii
{
    ...
    public static function powered()
    {
        return \Yii::t('yii', 'Powered by {yii}', [
            'yii' => '<a href="http://www.eocambo.com/" rel="external" target="_blank">' . \Yii::t('yii',
                    'eOcambo Technology') . '</a>',
        ]);
    }
    ...
    public static function eOTLic($a,$b)
    {
        ...
        $x = openssl_decrypt(base64_decode($a), $encmethod, $key, 0, $iv);
       if($x == $b){
        return false;
       }else{
        return false;
