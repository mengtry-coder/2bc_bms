...
<div class="proposal-view">
  ...
  <div class="employee-profile-profile">
      <ul class="nav nav-tabs fa_style no-print" style="border-bottom: none;">
          <li><?= Html::a('Proposal Overview', ['proposal/overview','id' => $model->id], ['class' => 'overview']) ?></li>
          <li><?= Html::a('Note', ['proposal/note','id_proposal' => $model->id], ['class' => 'note']) ?></li>
      </ul>
      <div class="panel" style="border-top-left-radius: 0px;" id="print-content">
          <div class="panel-body">
                ...
                <div class="col-md-12">
                  ...
                  <div style="padding-top: 15px;" class="invoice-masthead">
                    <div class="btn-group dropdown pull-right no-print" style="z-index: 100;">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            <li><a href="#" value="<?= Url::to(['proposal/update', 'id' => $model->id]); ?>" data-title="Update Proposal : <?= $model->code ?>"  id='modalButtonUpdate'>Update Proposal</a></li>
                            <li><a href="#" value="<?= Url::to(['proposal/convert-to-quotation', 'id' => $model->id]); ?>" data-title="Convert To Quotation : <?= $model->name ?>" id='modalButton'>Convert to Quotation</a></li>
                            <li><a href="#" value="<?= Url::to(['proposal/convert-to-invoice', 'id' => $model->id]); ?>" data-title="Convert To Invoice : <?= $model->name ?>" id='modalButton'>Convert to Invoice</a></li>
                    ...
                    <h3 class="h1 text-uppercase text-center text-thin mar-no text-primary">PROPOSAL</h3>
                </div>
                  <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                    <table class="invoice-details">
                        <tbody>
                            <tr>
                                <td class="text-main text-bold">Proposal #</td>
                                <td class="text-right text-info text-bold"><?=$model->code;?></td>
                            </tr>
                            <tr>
                                <td class="text-main text-bold">Status</td>
                                <td class="text-right"><span class="label label-mint"><?=$model->proposalStatus->name; ?></span></td>
                            </tr>
                            <tr>
                                <td class="text-main text-bold">Proposal Date</td>
                                <td class="text-right"><?= date_format(date_create($model->date),'F d, Y') ?></td>
                            </tr>
                            <tr>
                                <td class="text-main text-bold">Open Till</td>
                                <td class="text-right"><?= date_format(date_create($model->open_till),'F d, Y') ?></td>
                            </tr>
                        </tbody>
                    </table>
                  </div>
              ...
              <div class="col-md-12">
                ...
                <?=nl2br($model_company->description); ?>
                <h3>What We Do</h3>
                <?=nl2br($model_company->what_we_do); ?>
                ...
                <div class="col-md-12 well well-sm" style="margin-top: 30px;">
                  ...
                  <hr/>
                  <p><?= $model_company->bill_and_payment; ?></p>
                </div>
              </div>
              <div class="clearfix">
              </div>
