    ...
    <div class="row">
        <div class="col-md-12">
          ...
          <div class="col-md-3">
            ...
            <?php $form->field($model, 'allow_comment')->checkbox(['id'=>'demo-sw-checked', 'data-switchery'=>true]) ?>
...
$script = <<<JS
    ...
    $("#proposal-related_id").change(function(){
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                $('#proposal-id_lead_customer').html(str);
            }
        });
    ...
    $("#proposal-id_lead_customer").change(function(){
        ...
        // $(".field-task-id_related_profile label").text(text);
        var id = $(this).val();
        var is_customer_lead = $("#proposal-related_id").val();
        $.ajax({
            url: base_url+'/proposal/dependent-get-customer-info',
            type: 'post',
            data: {
                id: id,
                is_customer_lead: is_customer_lead,
                action: 'get_profile'
            },
            success: function(response){
                var data = JSON.parse(response);
