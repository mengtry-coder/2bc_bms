...
/* @var $searchModel backend\models\LeaveSetupSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Monthly Leave';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="leave-setup-index">
    ...
    <div class="panel"> 
        ...
        <?php
            Modal::begin([
                'header' => ' <h4 class="modal-title">'.'Monthly Leave'.'</h4>',
                'id' => 'modal',
                'class' => 'modal fade',
