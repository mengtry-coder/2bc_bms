...
<div class="customer-profile-import-csv">
    ...
    <div class='row'>
        <div class="col-md-12">
            <label><span style="color: #c62828;">Customer Profile</span> Demo structure <a type="button" class="btn btn-xs btn-info btn-rounded" href="<?= $base_url.'/customer-profile/download-sample-csv'?>" >Download Sample <i class="demo-psi-file-csv go-right"></i></a> of CSV file for import <span style="color: #283593;">(You have to follow this structure to avoid your data messy.)</span></label>
...
$("#customerprofile-file").change(function(){
    var filePath = $("#customerprofile-file").val();
    if(filePath !=""){
