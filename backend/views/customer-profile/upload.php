...
@$id_customer_profile = $_GET['id_customer_profile']; 
        $acceptedFiles = 
    ...
    ;
        // $url = Yii::getAlias('@web')."/customer-profile/upload?folder=14";
        
        
        echo    \kato\DropZone::widget([
            'options' => [
                'url'=>Yii::getAlias('@web')."/customer-profile/upload?folder=".$folder."&id_customer_profile=".$id_customer_profile, 
                'maxFilesize' => '5',
                'maxFiles'=>10,
                'addRemoveLinks'=>true,
                'multipleUpload'=>true,
...
$url = Yii::getAlias('@web')."/customer-profile/remove-file";
