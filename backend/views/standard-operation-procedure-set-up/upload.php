...
@$id_standard_operation_procedure_set_up = $_GET['id_standard_operation_procedure_set_up']; 
    ...
    ;
        // $url = Yii::getAlias('@web')."/standard-operation-procedure-set-up/upload?folder=14";
        
        
        echo    \kato\DropZone::widget([
            'options' => [
                'url'=>Yii::getAlias('@web')."/standard-operation-procedure-set-up/upload?folder=".$folder."&id_standard_operation_procedure_set_up=".$id_standard_operation_procedure_set_up, 
                'maxFilesize' => '5',
                'maxFiles'=>10,
                'addRemoveLinks'=>true,
                'multipleUpload'=>true,
...
$url = Yii::getAlias('@web')."/standard-operation-procedure-set-up/remove-file";
