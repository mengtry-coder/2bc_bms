...
/* @var $searchModel backend\models\StandardOperationStepSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Standard Operation Steps';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="standard-operation-step-index">
    ...
    <div class="panel"> 
            ...
            <div class="col-md-11">
                ...
                <div class="col-md-1">
                    <div class="pull-right">
                        <button data-target="#demo-default-modal" data-toggle="modal" class="btn btn-warning btn-rounded" id="modalButton" value="<?= Url::toRoute(['standard-operation-step/create']) ?>">                            Add New <i class="fa fa-plus-square go-right"></i>
                        </button> 
                    </div>
                </div>
            </div>
        ...
        <?php
            Modal::begin([
                'header' => ' <h4 class="modal-title">'.'Standard Operation Steps'.'</h4>',
                'id' => 'modal',
                'class' => 'modal fade',
                'size' => 'modal-md',
            ]);
        ...
        <div class="table-responsive">
                ...
                'name',
                [
                    'attribute' => 'id_employee_position',
                    'value' => 'possition.position_type'
                ],
...
<?php
$this->registerJs('
        var controller_id = "standard-operation-step";
