...
@$id_contract = $_GET['id_contract']; 
    ...
    ;
        // $url = Yii::getAlias('@web')."/contract/upload?folder=14";
        
        
        echo    \kato\DropZone::widget([
            'options' => [
                'url'=>Yii::getAlias('@web')."/contract/upload?folder=".$folder."&id_contract=".$id_contract, 
                'maxFilesize' => '5',
                'maxFiles'=>10,
                'addRemoveLinks'=>true,
                'multipleUpload'=>true,
...
$url = Yii::getAlias('@web')."/contract/remove-file";
