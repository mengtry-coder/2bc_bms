...
$this->title = 'Public Document'; 
$this->params['breadcrumbs'][] = 'Document'; 
$this->params['breadcrumbs'][] = ['label' => 'Public Document'];
$folder_data = ArrayHelper::map(\backend\models\Folder::find()
	->where(['status' => 1])
	->andWhere(['id_document_permission' => $document_permission])
	->all(), 'id', 'folder_name');  
...
<div class="document-index">
    ...
    <?php 
        require_once(__DIR__ . '/../site/_top_menu_document.php');
    ?>
    
	<div class="panel" style="border-top-left-radius: 0px;">
		<div class="panel-body">   
			<p class="text-main text-bold">Public Document</p>
			<hr>
...
//==== End Ajax query data by document name
        ...
        $("#select_page_size").change(function(){
            ...
            window.location.replace(url+"?r="+controller_id+"/subscriber&document_permission='.$document_permission.'&page_size="+page_size); 
        });
