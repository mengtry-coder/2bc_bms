...
@$document_permission = $_GET['document_permission']; 
        $acceptedFiles = 
    ...
    ;
        // $url = Yii::getAlias('@web')."/document/upload?folder=14";
        
        
        echo    \kato\DropZone::widget([
            'options' => [
                'url'=>Yii::getAlias('@web')."/document/upload?folder=".$folder."&document_permission=".$document_permission, 
                'maxFilesize' => '5',
                'maxFiles'=>10,
                'addRemoveLinks'=>true,
                'multipleUpload'=>true,
...
$url = Yii::getAlias('@web')."/document/remove-file";
