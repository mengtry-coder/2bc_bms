...
<div class="opening-balance-index">
    ...
    <div class="panel"> 
        ...
        <?php
            Modal::begin([
                'header' => ' <h4 class="modal-title">'.'Opening Balance'.'</h4>',
                'id' => 'modal',
                'class' => 'modal fade',
        ...
        <div class="table-responsive">
                ...
                [
                    'attribute'=>'id_chart_of_account',
                    'value' => function($model){
                        return $model->account->names;
                    }
                ],
                [
                    'attribute'=> 'amount',
...
<?php
$this->registerJs('
        var controller_id = "finance-opening-balance";
    ...
    ');
$url = URL::toRoute(['finance-opening-balance/view']);
$script = <<<JS
