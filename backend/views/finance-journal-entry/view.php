...
$this->title = "Journal Entry No. #".$model->doc_id;
?>
    ...
    <div class="panel" id="print-content">
        <div class="panel-body">
                ...
                <div style="padding-top: 15px;">
                    <div class="btn-group dropdown pull-right no-print" style="z-index: 100;">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            <li><a href="#" value="<?= Url::to(['finance-journal-entry/update', 'id' => $model->id]); ?>" data-title="Update Journal Entry : <?= $model->doc_id ?>"  id='modalButton'>Update Journal Entry</a></li>
                            ...
                            <li class="divider"></li>
                            <li><a class="button-void" data-value="<?= yii\helpers\Url::to(['finance-journal-entry/void', 'id' => $model->doc_id]); ?>" title="VOID" data-confirm="Are you sure want to void this file?" data-method="post">Void</a></li>
                            <?php } ?>
                        </ul>
                    </div>
                    <h3 class="h1 text-uppercase text-center text-thin mar-no text-primary">Journal Entry</h3>
                </div>
            </div>

            <div class="invoice-bill row">
                <div class="col-sm-6 col-xs-6 text-xs-center">
                    <strong class="text-main text-uppercase" style="font-size: 16px;">Debit to account </strong><br>
                    <span class="text-main text-semibold" style="font-size: 14px;"><?= $model->toAccount->names ?></span>
                </div>
                <div class="col-sm-6 col-xs-6 text-xs-center">
                ...
                <div class="col-lg-12 table-responsive">
                    <table class="table table-bordered invoice-summary">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <strong><?= $model->fromAccount->accountType->names; ?></strong>
                                    <span><?= $model->fromAccount->number_code .' | '. $model->fromAccount->names ?></span>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <strong><?= $model->toAccount->accountType->names; ?></strong>
                                    <span><?= $model->toAccount->number_code .' | '. $model->toAccount->names ?></span>
                                </td>
                                <td></td>
                                <td class="text-right">$<?= $model->amount; ?></td>
                            </tr>
            ...
            <div class="well well-sm">
                ...
                <p><?= nl2br(\backend\models\CompanyProfile::findOne(1)->info_journal_entry) ?></p>
            </div>
