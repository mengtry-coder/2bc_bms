...
<div class="item-group-index">
    ...
    <div class="panel">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="pull-right">
                        <button data-target="#demo-default-modal" data-toggle="modal" class="btn btn-warning btn-rounded" id="modalButton" value="<?= Url::toRoute(['item-group/create']) ?>">                            Add New <i class="fa fa-plus-square go-right"></i>
                        </button>
                    </div>
                </div>
            </div>
        ...
        <?php
            Modal::begin([
                'header' => ' <h4 class="modal-title">'.'Item Groups'.'</h4>',
                'id' => 'modal',
                'class' => 'modal fade',
                ...
                [
                    ...
                    'buttons' => [
                        'view' => function ($url, $model) {
                            return "<a target='_blank' href='". $url."' class='text-info'> Gorup Detail </a>";
