...
@$id_event_list = $_GET['id_event_list']; 
    ...
    ;
        // $url = Yii::getAlias('@web')."/event-list/upload?folder=14";
        
        
        echo    \kato\DropZone::widget([
            'options' => [
                'url'=>Yii::getAlias('@web')."/event-list/upload?folder=".$folder."&id_event_list=".$id_event_list, 
                'maxFilesize' => '5',
                'maxFiles'=>10,
                'addRemoveLinks'=>true,
                'multipleUpload'=>true,
...
$url = Yii::getAlias('@web')."/event-list/remove-file";
