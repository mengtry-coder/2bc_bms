...
<div class="form-inline">
    ...
    <?php $form = ActiveForm::begin([
        'action' => ['sale-expense', 'id_project'=> $_GET['id_project']],
        'method' => 'get',
    ]); ?>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="pull-right">
                ...
                <button type="button" data-title="New Expense" data-target="#demo-default-modal" data-toggle="modal" class="btn btn-warning btn-rounded" id="modalButtonInvoice" value="<?= Url::toRoute(['expense/create','project_id'=>$_GET['id_project']]) ?>"> Add New <i class="fa fa-plus-square go-right"></i>
                </button> 
