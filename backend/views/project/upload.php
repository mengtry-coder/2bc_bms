...
@$id_project = $_GET['id_project']; 
    ...
    ;
        // $url = Yii::getAlias('@web')."/project/upload?folder=14";
        
        
        echo    \kato\DropZone::widget([
            'options' => [
                'url'=>Yii::getAlias('@web')."/project/upload?folder=".$folder."&id_project=".$id_project, 
                'maxFilesize' => '5',
                'maxFiles'=>10,
                'addRemoveLinks'=>true,
                'multipleUpload'=>true,
...
$url = Yii::getAlias('@web')."/project/remove-file";
