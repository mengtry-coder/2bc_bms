...
<div class="project-form">
    ...
    ?>
    <div class="well">
        <input type="checkbox" name="checkbox_task" id="checkbox_task" value="1" checked>
        <label for="checkbox_task">Tasks</label>
    </div>
    <div class="row"> 
        <div class="col-md-12">
    ...
    <div class="text-right"> 
        <?= Html::submitButton('Copy Project', ['class' => 'btn btn-success btn-rounded']) ?>
    </div> 
