            ...
            <div class="panel-body">
                <div class="invoice-masthead">
                    ...
                    <div style="padding-top: 15px;">
                        ...
                        <h3 class="h1 text-uppercase text-center text-thin mar-no text-primary" style="color: #02A9F4 !important;">QUOTATION</h3>
                    </div>
                </div>
                ...
                <h5 class="text-center text-thin"><?= $company_profile->names ?> is pleased to offer the following QUOTATION</h5>
                ...
                <h4 class="pad-sm-all bg-info text-center" style="background: #02A9F4 !important; color: #fff !important;">SOLUTIONS RATES</h4>
                ...
                <table class="table table-bordered invoice-summary">
                    <tbody>
                        <tr>
                            ...
                            <td colspan="<?= count($total_plan) ?>" class="h5 text-center bg-eo" style="background: #FE6D00 !important; color: #fff !important;">RATES</td>
                        </tr>
                        <tr>
                            <?php 
                        ...
                        ?>
                            <tr>
                                <td colspan="<?= 2 + count($total_plan) ?>" class="h5 pad-sm-all bg-info" style="background: #02A9F4 !important; color: #fff !important;"><?= $v->name ?></td>
                            </tr>
                    ...
                    <tbody>
                                  ...
                                  <tr>
                                     <td style='background:#EEEEEE !important;padding:0 0 10px 0'>
                                        <p class=MsoNormal align=center style='text-align:center;line-height:
                                           106%'><b><span style='font-size: 18px !important; color:#1F497D !important'>OUR SOLUTIONS</span></b>
                                        </p>
                                     </td>
                                  </tr>
                                  <tr><td style='background:#EEEEEE !important;padding:0 0 10px 0'><hr></td></tr>
                               </table>
                                       ...
                                       ?>
                                        <td width=76 style='background:#EEEEEE !important;text-align: center'>
                                           <p class=MsoNormal style='line-height:106%'><a
                                              href="#"><span style='color:black;text-decoration:
                                              none'><img border=0 width=38 height=38 src="<?= $img_url; ?>" onError="this.onerror=null;this.src='<?= $base_url.'/backend/uploads/bms_logo.png' ?>';"></span></a></p>
                                        </td>
                                        <?php
                                            }
                                        ?>
                        ...
                        <tr>
                            <td style='background:#EEEEEE !important;padding:22.5pt 15.0pt 22.5pt 15.0pt'>
                               <p class=MsoNormal style='line-height:106%'><b><span style='color:#1F497D !important'>Our Mission:</span></b></p>
                               ...
                               <p class=MsoNormal style='line-height:106%'><b><span style='color:#1F497D !important'>Our Vision:</span></b></p>
                               <ul style='margin-top:0in' type=disc>
                                  <li class=MsoNormal style='color:#1F497D !important;line-height:106%'>
                                     <span style='color:#1F497D !important;'>
