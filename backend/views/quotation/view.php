                  ...
                  <div style="padding-top: 15px;" class="invoice-masthead">
                    <div class="btn-group dropdown pull-right no-print" style="z-index: 100;">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            <li><a href="#" value="<?= Url::to(['quotation/update', 'id' => $model->id]); ?>" data-title="Update quotation : <?= $model->code ?>"  id='modalButtonUpdate'>Update quotation</a></li>
                            <li><a href="#" value="<?= Url::to(['quotation/convert-to-invoice', 'id' => $model->id]); ?>" data-title="Convert To Invoice : <?= $model->name ?>" id='modalButton'>Convert to Invoice</a></li>
                    ...
                    <table class="invoice-details">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-right"><span class="label label-mint"><?=$model->quotationStatus->name; ?></span></td>
                            </tr>
                            <tr>
