...
$this->title = 'Contract Notes';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="contract-note-index">
    ...
    <!-- <div class="panel"> 
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="pull-right">
                        <button data-target="#demo-default-modal" data-toggle="modal" class="btn btn-warning btn-rounded" id="modalButton" value="<?= Url::toRoute(['contract-note/create?id_contract='.$id_contract]);?>">Add New <i class="fa fa-plus-square go-right"></i>
                        </button> 
                    </div>
                </div>
            </div>
        ...
        <?php
            Modal::begin([
                'header' => ' <h4 class="modal-title">'.'Contract Notes'.'</h4>',
                'id' => 'modal',
                'class' => 'modal fade',
                'size' => 'modal-md',
            ]);
...
$this->registerJs(' 
        ...
        var controller_id = "contract-note";
