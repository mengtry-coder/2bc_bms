...
$this->title = 'Subscriber Profiles';
$this->params['breadcrumbs'][] = $this->title;
$membership_profile_subscriber = URL::toRoute(['membership-profile/subscriber-detail']);
...
<div class="membership-profile-subscriber">
    ...
    <div class="panel"> 
        <div class="panel-body">  
            <div class="row">
                <div class="col-md-12">
                <?= $this->render('_search_subscriber', ['model' => $searchModel]); ?>
        ...
        <div class="table-responsive">
                ...
                [ 
                    ...
                    'value' => function ($data) { 
                        ...
                        return Html::img($img_url,['width' => '40px','height' => '40px']);
                        // return $base_url;
                        // backend/web/backend/uploads/NoPicAvailable.jpg
                    },
                ],
            ...
            [
                ...
                [
                    ...
                    'contentOptions' => ['class' => 'text-center'],
                    'template' => '{subscriber-detail} {update} {delete-subscriber}',
                    'buttons' => [
                        ...
                        'subscriber-detail' => function ($url, $model) {
                        ...
                        'delete-subscriber' => function ($url, $model) {
...
$this->registerJs('
        ...
        $("#select_page_size").change(function(){
            ...
            var url = window.location.pathname;
                window.location.replace(url+"?r="+controller_id+"/subscriber&page_size="+page_size);
        });
...
$("td").click(function (e) {
    ...
    var url = "$membership_profile_subscriber" + '?id=' + id;
    if(e.target == this)
        location.href = url;
});
JS;
