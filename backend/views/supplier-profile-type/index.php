...
/* @var $searchModel backend\models\SupplierProfileTypeSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Supplier Profile Types';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="supplier-profile-type-index">
    ...
    <div class="panel"> 
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="pull-right">
                        <button data-target="#demo-default-modal" data-toggle="modal" class="btn btn-warning btn-rounded" id="modalButton" value="<?= Url::toRoute(['supplier-profile-type/create']) ?>">                            Add New <i class="fa fa-plus-square go-right"></i>
                        </button> 
                    </div>
                </div>
            </div>
        ...
        <?php
            Modal::begin([
                'header' => ' <h4 class="modal-title">'.'Supplier Profile Types'.'</h4>',
                'id' => 'modal',
                'class' => 'modal fade',
                'size' => 'modal-md',
            ]);
...
<?php
$this->registerJs('
        var controller_id = "supplier-profile-type";
