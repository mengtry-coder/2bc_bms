...
<div class="lead-profile-import-csv">
    <?php $form = ActiveForm::begin([
    'action'=> Url::toRoute(['import-csv']),
    'options' => [
    ...
    <div class='row'>
        <div class="col-md-12">
            <label><span style="color: #c62828;">Lead Profile</span> Demo structure <a type="button" class="btn btn-xs btn-info btn-rounded" href="<?= $base_url.'/lead-profile/download-sample-csv'?>" >Download Sample <i class="demo-psi-file-csv go-right"></i></a> of CSV file for import <span style="color: #283593;">(You have to follow this structure to avoid your data messy.)</span></label>
            ...
            <div class="table-responsive">  
                ...
                <table border="1" width="100%" style="border-color: #0000006e;">
                    <tr style="background-color: #ababab3d;"> 
                        ...
                        <td>
                            Lead Name <span style="color:red;"><b>&#42;</b></span>
                        </td>
                        <td>
                            Company Name <span style="color:red;"><b>&#42;</b></span>
                        </td>
                        <td>
                            Address <span style="color:red;"><b>&#42;</b></span>
                        </td>
                        <td>
...
$("#leadprofile-file").change(function(){
    var filePath = $("#leadprofile-file").val();
    if(filePath !=""){
