...
@$id_lead_profile = $_GET['id_lead_profile']; 
    ...
    ;
        // $url = Yii::getAlias('@web')."/lead-profile/upload?folder=14";
        
        
        echo    \kato\DropZone::widget([
            'options' => [
                'url'=>Yii::getAlias('@web')."/lead-profile/upload?folder=".$folder."&id_lead_profile=".$id_lead_profile, 
                'maxFilesize' => '5',
                'maxFiles'=>10,
                'addRemoveLinks'=>true,
                'multipleUpload'=>true,
...
$url = Yii::getAlias('@web')."/lead-profile/remove-file";
