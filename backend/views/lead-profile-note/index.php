...
$this->title = 'Lead Profile Notes';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="lead-profile-note-index">
    ...
    <div class="panel"> 
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="pull-right">
                        <button data-target="#demo-default-modal" data-toggle="modal" class="btn btn-warning btn-rounded" id="modalButton" value="<?= Url::toRoute(['lead-profile-note/create?id_lead_profile='.$id_lead_profile]);?>">Add New <i class="fa fa-plus-square go-right"></i>
                        </button> 
                    </div>
                </div>
            </div>
        ...
        <?php
            Modal::begin([
                'header' => ' <h4 class="modal-title">'.'Lead Profile Notes'.'</h4>',
                'id' => 'modal',
                'class' => 'modal fade',
                'size' => 'modal-md',
            ]);
...
$this->registerJs(' 
        ...
        var controller_id = "lead-profile-note";
