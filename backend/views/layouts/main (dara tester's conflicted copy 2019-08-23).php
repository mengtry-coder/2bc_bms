...
<?php $this->beginBody() ?>
                    ...
                    <ul class="nav navbar-top-links no-print">
                        ...
                        <li id="dropdown-user" class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right panel-default">
                                <ul class="head-list">
                                    <li>
                                        <a href="#" value="<?= Url::toRoute(['employee-profile/update', 'id'=> Yii::$app->user->identity->id_employee ]) ?>" data-target="#demo-default-modal" data-toggle="modal" id="modalButtonUpdateProfile"><i class="demo-pli-male icon-lg icon-fw"></i> Profile</a>
                                    </li>
                                    <li>
    ...
    <?php
            ...
            echo "<div id='modalContentUpdateProfile'></div>";
            Modal::end();
...
$this->registerJs('
        ...
        $(document).on("click","#modalButtonUpdateProfile",function () {
            $("#modal").modal("show")
                .find("#modalContentUpdateProfile")
                .load($(this).attr("value"));
            $("#modal").find(".modal-title").html(title);
            // $(".modal-dialog").removeClass("modal-lg").addClass("modal-invoice");
        });
