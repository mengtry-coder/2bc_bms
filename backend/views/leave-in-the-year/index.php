...
/* @var $searchModel backend\models\LeaveInTheYearSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Leave In The Years';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="leave-in-the-year-index">
    ...
    <div class="panel">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="pull-right">
                        <button data-target="#demo-default-modal" data-toggle="modal" class="btn btn-warning btn-rounded" id="modalButton" value="<?= Url::toRoute(['leave-in-the-year/create']) ?>">                            Add New <i class="fa fa-plus-square go-right"></i>
                        </button>
                    </div>
                </div>
            </div>
        ...
        <?php
            Modal::begin([
                'header' => ' <h4 class="modal-title">'.'Leave In The Years'.'</h4>',
                'id' => 'modal',
                'class' => 'modal fade',
                'size' => 'modal-lg',
            ]);
        ...
        <div class="table-responsive">
            ...
            //     'value' => function($model){
            //         return $model->createdBy->first_name;
            //     }
            // ],
...
<?php
$this->registerJs('
        var controller_id = "leave-in-the-year";
