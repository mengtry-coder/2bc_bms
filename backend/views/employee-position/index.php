...
<div class="employee-position-index">
    ...
    <div class="panel">
            ...
            <div class="row">
                ...
                <div class="col-md-1">
                    <div class="pull-right">
                        <button data-target="#demo-default-modal" data-toggle="modal" class="btn btn-warning btn-rounded" id="modalButton" value="<?= Url::toRoute(['employee-position/create']) ?>">                            Add New <i class="fa fa-plus-square go-right"></i>
                        </button>
                    </div>
                </div>
            </div>
        ...
        <?php
            Modal::begin([
                'header' => ' <h4 class="modal-title">'.'Employee Positions'.'</h4>',
                'id' => 'modal',
                'class' => 'modal fade',
                'size' => 'modal-lg',
            ]);
...
<?php
$this->registerJs('
        var controller_id = "employee-position";
