...
$related_to = ArrayHelper::map(\backend\models\CustomerProfile::find()
    ->all(), 
    function($model)
    {
            ...
            <div class="col-md-12">
                <div class="panel panel-body" style="padding: 8px 20px 2px;"> 
                    <div class="row"> 
                        ...
                        <div class="col-md-3">
                            <?= $form->field($model, 'related_to')->widget(Select2::classname(), [
                                'data' => $related_to,
        ...
        <div class="row"> 
            ...
            <div class="col-md-10 col-sm-9"> 
                <div class="panel">
                    ...
                    <div class="text-2x text-center">SALE REPORT by PROPOSAL</div>
                    <?php 
                    ...
                    <br> 
                        ...
                        <table class="table table-condensed">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?=$rang_no++;?></td>
                                    <td><a target="_blank" href="<?=URL::toRoute(['proposal/overview','id'=>$value['id'], 'smMenu'=>1])?>" class="text-info" ><?=$value['code'];?></a></td>
                                    <td><?=$value['name'];?></td>
                                    <td><?=$value['lead_or_customer'];?></td>
