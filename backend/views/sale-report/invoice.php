        ...
        <div class="row"> 
            ...
            <div class="col-md-10 col-sm-9"> 
                <div class="panel">
                    ...
                    <div class="text-2x text-center">SALE REPORT by INVOICE</div>
                    <?php 
                    ...
                    <br> 
                        ...
                        <table class="table table-condensed">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?=$rang_no++;?></td>
                                    <td><a target="_blank" href="<?=URL::toRoute(['customer-invoice/view','id'=>$value['id_customer_invoice'], 'smMenu'=>1])?>" class="text-info" ><?=$value['doc_id'];?></a></td>
                                    <td class="text-center"><?=$value['date'];?></td>
                                    <td><a href="<?=URL::toRoute(['customer-profile/profile','id'=>$value['id_customer'], 'smMenu'=>1])?>" target='_blank' class='text-info'><?=$value['customer_name'];?></a></td>
                                    <td><?=$value['project_name'];?></td>
                                    <td class="text-center"><?=$value['status'];?></td>
                                    <td class="text-right"><?='$ '.number_format($value['total_amount'],2);?></td>
                                    <td class="text-right"><?='$ '.number_format($value['receive_amount'],2);?></td>
                                    <td class="text-right"><?='$ '.number_format($value['balance_amount'],2);?></td> 
                                </tr>
                                <?php }?>
                                <tr>
                                    <td colspan="6">
                                    ...
                                    <td colspan="1">
                                        <div class="text-bold text-right"><?='$ '.number_format($totalAmount,2);?></div>
                                    </td>
                                    <td colspan="1">
                                        <div class="text-bold text-right"><?='$ '.number_format($receiveAmount,2);?></div>
                                    </td>
                                    <td colspan="1">
                                        <div class="text-bold text-right"><?='$ '.number_format($balanceAmount,2);?></div>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
