...
<div class="membership-type-index">
    <div class="panel"> 
        <div class="panel-body">  
            <div class="row">
                <div class="col-md-12">
                    <div class="pull-right">
                        <button data-target="#demo-default-modal" data-toggle="modal" class="btn btn-warning btn-rounded" id="modalButton" value="<?= Url::toRoute(['membership-type/create'])?>">
            ...
            <?php 
                Modal::begin([
                    'header' => ' <h4 class="modal-title"> Membership Type </h4>',
                    'id' => 'modal',
                    'class' => 'modal fade',
                    'size' => 'modal-md',
                ]);
...
<?php
$this->registerJs('
        var controller_id = "membership-type";
