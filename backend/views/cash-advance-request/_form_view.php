...
<div class="cash-advance-request-form">
    ...
    ?>
        ...
        <div class="row">
            <div class="col-md-12">
                <?= $form->field($model, 'chart_of_account')->widget(Select2::classname(), [
                    ...
                    'pluginOptions' => [
                        'allowClear' => false
                    ]])->label('Account # Available $<span id="chart_of_account_amount">'.$available_amount.'</span>');
                ?>        
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <?= $form->field($model, 'amount_in_word')->textArea(['rows' => 3, 'readonly'=>true, 'style'=>'letter-spacing: 2px; background: #fff4f4; font-weight: bolder;']) ?>
            </div>
        </div>
    ...
    <div class="text-right <?= $model->status == 0 ? 'hide' : '' ?>"> 
