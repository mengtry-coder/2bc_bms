...
/* @var $searchModel backend\models\DataOptionPrefixSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Data Option Prefixes';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="data-option-prefix-index">
    ...
    <div class="panel"> 
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="pull-right">
                        <button data-target="#demo-default-modal" data-toggle="modal" class="btn btn-warning btn-rounded" id="modalButton" value="<?= Url::toRoute(['data-option-prefix/create']) ?>">                            Add New <i class="fa fa-plus-square go-right"></i>
                        </button> 
                    </div>
                </div>
            </div>
        ...
        <?php
            Modal::begin([
                'header' => ' <h4 class="modal-title">'.'Data Option Prefixes'.'</h4>',
                'id' => 'modal',
                'class' => 'modal fade',
                'size' => 'modal-md',
            ]);
...
<?php
$this->registerJs('
        var controller_id = "data-option-prefix";
