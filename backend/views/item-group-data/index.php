...
/* @var $searchModel backend\models\ItemGroupDataSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Item Group Data';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="item-group-data-index">
    ...
    <div class="panel"> 
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="pull-right">
                        <button data-target="#demo-default-modal" data-toggle="modal" class="btn btn-warning btn-rounded" id="modalButton" value="<?= Url::toRoute(['item-group-data/create']) ?>">                            Add New <i class="fa fa-plus-square go-right"></i>
                        </button> 
                    </div>
                </div>
            </div>
        ...
        <?php
            Modal::begin([
                'header' => ' <h4 class="modal-title">'.'Item Group Datas'.'</h4>',
                'id' => 'modal',
                'class' => 'modal fade',
                'size' => 'modal-md',
            ]);
...
<?php
$this->registerJs('
        var controller_id = "item-group-data";
