...
class MembershipProfile extends \yii\db\ActiveRecord
{
    ...
    public function behaviors(){
      return [
          [
              ...
              'uploadPath' => '@backend/web/backend/uploads/membership-profile', // saved directory. default to '@runtime/upload'
    ...
    public function rules()
    {
        return [
            [['username'], 'unique'],
            [['email'],'email'],
            [['id_prefix', 'first_name', 'last_name', 'company_name', 'nationality', 'address', 'username','membership_type', 'email'], 'required'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'phone_number_line_2' => 'Phone Number 2',
            'email' => 'Email',
            'website' => 'Website',
    ...
    {
      return $this->hasOne(DataOptionPhoneNumberCountryCode::className(),['id'=>'prefix_phone_code']);
    }
    public function getPrefixPhone2()
    {
      return $this->hasOne(DataOptionPhoneNumberCountryCode::className(),['id'=>'prefix_phone_code_line_2']);
    }
