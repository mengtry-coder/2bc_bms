...
/**
 * MembershipDocumentController implements the CRUD actions for MembershipDocument model.
 */
class MembershipDocumentController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * Lists all MembershipDocument models.
     * @return mixed
     */
    ...
    /**
     * Displays a single MembershipDocument model.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Creates a new MembershipDocument model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new MembershipDocument();
    ...
    public function actionUpload($folder,$id_membership_profile)
    {
        // $id_membership_profile = $id;
            ...
            if (isset($_FILES[$fileName]))
            {
                ...
                if (isset($file)) {
                    ...
                    elseif(
                        ...
                        $model_file->id_membership_profile = $id_membership_profile;
                        $model_file->status = 1;
    ...
    public function actionCreateFolder()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            FROM folder
            WHERE folder.id_membership_profile = "'.$model->id_membership_profile.'"
    ...
    /**
     * Updates an existing MembershipDocument model.
    ...
    /**
     * Deletes an existing MembershipDocument model.
    ...
    /**
     * Finds the MembershipDocument model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return MembershipDocument the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = MembershipDocument::findOne($id)) !== null) {
            return $model;
        }
